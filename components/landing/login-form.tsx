...
export function LoginForm() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // Acá irá tu lógica de autenticación
    ...
    return (
        <div className="w-full max-w-md p-8 bg-zinc-950 border border-zinc-800 rounded-2xl shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                    type="submit"
                    className="cursor-pointer w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-2.5 rounded-lg transition-colors mt-2"
                >
                    Sign In
                </button>
            </form>
            ...
            <p className="text-center text-sm text-zinc-400 mt-6">
                Don&apos;t have an account? <Link href="/register" className="text-blue-500 hover:text-blue-400">Sign up</Link>
            </p>
        </div>
    );
}
